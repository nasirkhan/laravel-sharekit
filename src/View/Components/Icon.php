...
class Icon extends Component
{
    ...
    protected function iconMarkup(string $network): string
    {
        return match ($network) {
            'x'        => '<path fill="currentColor" d="M13.7 10.2 21.5 1h-1.8l-6.8 8-5.4-8H1.2l8.2 12.1L1.2 23h1.8l7.2-8.5 5.8 8.5h6.3l-8.6-12.8Zm-2.5 3-0.8-1.2L3.8 2.4h2.8l5.3 7.8 0.8 1.2 6.9 10.2h-2.8l-5.6-8.4Z"/>',
